...
All Projects Across the state and total financing across all three states.
...
chart2 <- ggplot(data=data,aes(x=State,y=total))+
  ...
  theme_classic()+
  labs(y='Total Financing For Projects',y='State')+
...
chart5 <- ggplot(data=data,aes(x=State,y=Nature_Based))+
  ...
  scale_y_continuous(labels = label_dollar())+
  theme_classic()+
  labs(y='Project Financing (USD)',y='State')+
...
chart6 <- ggplot(data=money_join,aes(x=State,y=percent_nbs))+
  ...
  scale_y_continuous(limits=c(0,0.2),labels = scales::percent)+
  labs(y='Percent of Financing',x='State')+
  theme_classic()+
  theme(panel.grid.major.y = element_line(color = "gray90",linewidth = 0.5),plot.title = element_text(hjust = 0.5),axis.title = element_text(size=13),axis.text = element_text(size = 13))
...
data %>%
  ...
  ggplot(aes(x=State,y=values,fill=type))+
    ...
    scale_y_continuous(labels = label_dollar())+
    labs(y='Total Financing (USD)',x='State')+
    theme(panel.grid.major.y = element_line(color = "gray90",linewidth = 0.5),plot.title = element_text(hjust = 0.5),axis.title = element_text(size=13),axis.text = element_text(size = 13),legend.position="bottom")

ggsave('outputs/Project_Analysis/nature_based_totals.png',units='in',width=5,height=5)
...
ggplot(data=de_river_data,aes(x=State,y=total))+
  ...
  labs(y='Total Financing (USD)',x='State')+
  theme(panel.grid.major.y = element_line(color = "gray90",linewidth = 0.5))+
  ggtitle('Total Financing for CWSRF Projects By State')+
  theme(panel.grid.major.y = element_line(color = "gray90",linewidth = 0.5),plot.title = element_text(hjust = 0.5),axis.title = element_text(size=13),axis.text = element_text(size = 13))
...
ggsave('outputs/Project_Analysis/nature_based_totals_basin.png',units='in',width=5,height=5)
...
ggplot(agg, aes(x="", y=percent_funding , fill=Hardship_Disadvantaged_Communit))+
  ...
  scale_fill_manual(values=c('#ffe093','lightgreen'),name='Disadvantaged Community')+
  theme_void()+
  labs(title='% of CWSRF Financing in Pennsylvania Going to Disadvantaged Communities')
...
ggplot(hardship_funding, aes(x="", y=percent, fill=name))+
  ...
  theme_void()+
  labs(title='% of CWSRF Financing in Pennslyvania that was Subsized \n July 2017 to June 2023')
...
ggplot()+
  ...
  labs(title='Financing by Project Category in Disadvantaged Communities \n July 2017 to June 2023')+
  theme_void()
